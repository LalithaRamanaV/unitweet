...
function CommentModal() {
    ...
    <div>
        ...
        {open && (
         ...
         className="max-w-lg w-[90%] h-[300px] absolute top-24 left-[50%] translate-x-[-50%] bg-white border-1 rounded-xl border-gray-100 shadow-md">
            <div className="p-1">
                <div className=" border-gray-200 py-2 px-1.5">
           ...
           <div className="w-full divide-y divide-gray-200">
            ...
            <div className="flex items-center justify-between pt-2.5">
             ...
             <button onClick={sendComment} disabled={!input.trim()} className="bg-blue-400 text-white px-4 py-1.5 rounded-full font-bold shadow-md hover:brightness-95 ">Reply</button>
